...
def parse_args(check=True):
    ...
    parser.add_argument('--Origin', type=str, default='QuanSongCi.txt',
                        help='path to QuanSongCi.txt')

    parser.add_argument('--text', type=str, default='iQuanSongCi.txt',
                        help='path to QuanSongCi.txt')
    ...
    parser.add_argument('--reversed_dictionary', type=str, default='reversed_dictionary.json',
                        help='path to reversed_dictionary.json.')
